return {
    {
        ...
        dependencies = {
            ...
            -- Allows for extra capabilities by nvim-cmp
            "saghen/blink.cmp",
        ...
        config = function()
            ...
            vim.api.nvim_create_autocmd('LspAttach', {
                ...
                callback = function(event)
                    ...
                    -- Follow two autocmds are used to highlight references of the word under your cursor
                    -- when your cursor rests for a bit. `:help CursorHold` for info
                    ...
                    -- The following creates a keymap to toggle inlay hints in your code
            ...
            -- Mmake hover window have borders
